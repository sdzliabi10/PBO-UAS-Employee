...
public class MainEmployee {
    ...
    public static void main(String[] args) {
        Manager manager = new Manager("Sofiullah Abi Sadzili");
        Developer developer = new Developer("Sofiullah Abi Sadzili");
        Designer designer = new Designer("Sofiullah Abi Sadzilii");
